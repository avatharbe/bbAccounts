 ...
 * baseline (`v1_3_0_schema`) and the module rows (`v1_3_0_modules`)
 * because:
 *
 ...
 */
class v1_3_0_config extends \phpbb\db\migration\migration
{
	public static function depends_on()
	{
		return ['\avathar\bbaccounts\migrations\v1_3_0_schema'];
	}
