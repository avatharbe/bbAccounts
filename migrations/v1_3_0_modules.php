 ...
 * `v1_3_0_config` because the ACP module_auth strings reference the
 ...
 */
class v1_3_0_modules extends \phpbb\db\migration\migration
{
	public static function depends_on()
	{
		return ['\avathar\bbaccounts\migrations\v1_3_0_config'];
	}
