...
class ledger_anonymize_player_test extends \avathar\bbaccounts\tests\bbaccounts_test_case
{
	...
	public function test_anonymize_player_subledger_rewrites_matching_rows(): void
	{
		...
		$sql = 'SELECT COUNT(*) AS c FROM phpbb_bbaccounts_journal_lines WHERE subledger_player_id = 42';
		...
		$sql = 'SELECT COUNT(*) AS c FROM phpbb_bbaccounts_journal_lines WHERE subledger_player_id = 99';
		$result = $this->db()->sql_query($sql);
	...
	public function test_anonymize_player_subledger_supports_custom_replacement(): void
	{
		...
		$sql = 'SELECT subledger_player_id FROM phpbb_bbaccounts_journal_lines WHERE subledger_player_id = 7';
		$result = $this->db()->sql_query($sql);
	...
	public function test_anonymize_player_subledger_does_not_touch_user_subledger(): void
	{
		...
		$sql = 'SELECT COUNT(*) AS c FROM phpbb_bbaccounts_journal_lines WHERE subledger_user_id = 42';
		$result = $this->db()->sql_query($sql);
